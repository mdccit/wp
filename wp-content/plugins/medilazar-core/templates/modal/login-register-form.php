                ...
                <nav class="opal-tab-nav">
                    <ul>
                        <li class="tab-current"><a
                                    href="#opal-tab-login"><span><?php esc_html_e( 'Login', 'medilazar-core' ) ?></span></a>
                        </li>
                        <li>
                            <a href="#opal-tab-register"><span><?php esc_html_e( 'Register', 'medilazar-core' ) ?></span></a>
                        </li>
                    </ul>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="username" type="text"
                                                   ...
                                                   placeholder="<?php esc_attr_e( 'Username', 'medilazar-core' ) ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input name="password" type="password"
                                                   class="form-control" required
                                                   placeholder="<?php esc_attr_e( 'Password', 'medilazar-core' ) ?>">
                                        </div>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input name="remember"
                                                   type="checkbox"> <?php _e( 'Remember Me', 'medilazar-core' ) ?>
                                        </label>
                                    </div>
									<?php do_action( 'opalrealestate_captcha', 'login_form' ) ?>
                                    <button type="submit" data-button-action
                                            class="btn btn-primary btn-block"><?php _e( 'Login', 'medilazar-core' ) ?></button>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                   placeholder="<?php esc_html_e( 'Username', 'medilazar-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                   placeholder="<?php esc_html_e( 'Email', 'medilazar-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password"
                                                   placeholder="<?php esc_html_e( 'Password', 'medilazar-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password2"
                                                   placeholder="<?php esc_html_e( 'Confirm Password', 'medilazar-core' ); ?>"
                                                   required>
                                        </div>
                                    </div>
									<?php do_action( 'opalrealestate_captcha', 'register_form' ) ?>
                                    <button type="submit" data-button-action
                                            class="btn btn-primary btn-block"><?php _e( 'Register', 'medilazar-core' ) ?></button>
