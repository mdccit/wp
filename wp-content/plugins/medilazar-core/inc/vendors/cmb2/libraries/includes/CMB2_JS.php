...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'medilazar-core' ),
			'defaultString' => esc_html__( 'Default', 'medilazar-core' ),
			'pick'          => esc_html__( 'Select Color', 'medilazar-core' ),
			'current'       => esc_html__( 'Current Color', 'medilazar-core' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'medilazar-core' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'medilazar-core' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'medilazar-core' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'medilazar-core' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'medilazar-core' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'medilazar-core' ) ),
					'nextText'        => esc_html__( 'Next', 'medilazar-core' ),
					'prevText'        => esc_html__( 'Prev', 'medilazar-core' ),
					'currentText'     => esc_html__( 'Today', 'medilazar-core' ),
					'closeText'       => esc_html__( 'Done', 'medilazar-core' ),
					'clearText'       => esc_html__( 'Clear', 'medilazar-core' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'medilazar-core' ),
					'timeText'      => esc_html__( 'Time', 'medilazar-core' ),
					'hourText'      => esc_html__( 'Hour', 'medilazar-core' ),
					'minuteText'    => esc_html__( 'Minute', 'medilazar-core' ),
					'secondText'    => esc_html__( 'Second', 'medilazar-core' ),
					'currentText'   => esc_html__( 'Now', 'medilazar-core' ),
					'closeText'     => esc_html__( 'Done', 'medilazar-core' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'medilazar-core' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'medilazar-core' ),
				'upload_files' => esc_html__( 'Use these files', 'medilazar-core' ),
				'remove_image' => esc_html__( 'Remove Image', 'medilazar-core' ),
				'remove_file'  => esc_html__( 'Remove', 'medilazar-core' ),
				'file'         => esc_html__( 'File:', 'medilazar-core' ),
				'download'     => esc_html__( 'Download', 'medilazar-core' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'medilazar-core' ),
			),
		);
