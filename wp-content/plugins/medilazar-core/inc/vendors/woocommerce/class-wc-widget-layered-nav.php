...
class OSF_Widget_Layered_Nav extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __('Display a list of attributes to filter products in your store.(OSF custom)', 'medilazar-core');
        $this->widget_id          = 'otf_woocommerce_layered_nav';
        $this->widget_name        = __('OSF Filter Products by Attribute', 'medilazar-core');
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title'        => array(
                'type'  => 'text',
                'std'   => __('Filter by', 'medilazar-core'),
                'label' => __('Title', 'medilazar-core'),
            ),
            'attribute'    => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __('Attribute', 'medilazar-core'),
                'options' => $attribute_array,
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __('Display type', 'medilazar-core'),
                'options' => array(
            ...
            'style'        => array(
                ...
                'options' => array(
                    'one_column'  => __('1 Column', 'medilazar-core'),
                    'two_columns' => __('2 Columns', 'medilazar-core'),
                    'inline'      => __('Inline', 'medilazar-core'),
                ),
            ),
            'query_type'   => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __('Query type', 'medilazar-core'),
                'options' => array(
                    'and' => __('AND', 'medilazar-core'),
                    'or'  => __('OR', 'medilazar-core'),
                ),
            ),
        );
    }
