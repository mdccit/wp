...
class OSF_Elementor_Google_Map extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Google Maps', 'medilazar-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __('Latitude', 'medilazar-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '21.030497',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'medilazar-core' ), 'https://www.google.com/maps')
            )
        ...
        $this->add_control(
            'longitude',
            array(
                'label'   => __('Longitude', 'medilazar-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '105.852510',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Ex: 21.030497, 105.852510. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'medilazar-core' ), 'https://www.google.com/maps')
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => [ 'size' => 500 ],
                'description' => esc_html__( 'Height of map.(px)', 'medilazar-core' ),
                'selectors' => [
        ...
        $this->add_control(
            'zoom',
            [
                'label' => __( 'Zoom Level', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'prevent_scroll',
            [
                'label' => __( 'Prevent Scroll', 'medilazar-core' ),
        ...
        $this->start_controls_section(
            'section_style_map',
            [
                'label' => __( 'Map Style', 'medilazar-core' ),
        ...
        $this->add_control(
            'style',
            [
                'label' => __('Select Style', 'medilazar-core'),
        ...
        $this->add_control(
            'all',
            [
                'label' => __( 'All Color', 'medilazar-core' ),
        ...
        $this->add_control(
            'water_color',
            [
                'label' => __( 'Water Color', 'medilazar-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'style' => 'customize',
        ...
        $this->add_control(
            'water_lightness',
            [
                'label' => __( 'Water Lightness', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            'landscape_color',
            [
                'label' => __( 'Landscape Color', 'medilazar-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control(
            'landscape_lightness',
            [
                'label' => __( 'Landscape Lightness', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Color', 'medilazar-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Lightness', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'poi_color',
            [
                'label' => __( 'Poi Color', 'medilazar-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control(
            'poi_lightness',
            [
                'label' => __( 'Poi Lightness', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'road_color',
            [
                'label' => __( 'Road Color', 'medilazar-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control(
            'road_lightness',
            [
                'label' => __( 'Road Lightness', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'transit_color',
            [
                'label' => __( 'Transit Color', 'medilazar-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control(
            'transit_lightness',
            [
                'label' => __( 'Transit Lightness', 'medilazar-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
    ...
    private function data_style_title(){
        return array(
            ...
            'ultra_light' => __('Ultra Light', 'medilazar-core'),
            'shades_of_grey' => __('Shades of Grey', 'medilazar-core'),
            'blue_water' => __('Blue Water', 'medilazar-core'),
            'light_grey_and_blue' => __('Light Grey and Blue', 'medilazar-core'),
            'farma_gray' => __('Farma Gray', 'medilazar-core'),
            'community' => __('Community', 'medilazar-core'),
            'chilled' => __('Chilled', 'medilazar-core'),
            'customize' => __('Customize', 'medilazar-core')
