...
class OSF_Elementor_Accordion extends Widget_Accordion {
    ...
    public function get_title() {
        return __('Accordion', 'medilazar-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_title',
            [
                'label' => __('Accordion', 'medilazar-core'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => __('Accordion Title', 'medilazar-core'),
                'dynamic'     => [
                    'active' => true,
                ],
                'label_block' => true,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => __('Accordion Content', 'medilazar-core'),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Accordion Items', 'medilazar-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Accordion #1', 'medilazar-core'),
                    ...
                    [
                        'tab_title'   => __('Accordion #2', 'medilazar-core'),
                        'tab_content' => __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'medilazar-core'),
                    ],
                ],
