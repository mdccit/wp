...
class OSF_Customize_Control_Background_Position extends WP_Customize_Control {
	...
	public function render_content() {
		$options = array(
			array(
				'left top'   => array(
					'label' => __( 'Top Left', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center top' => array(
					'label' => __( 'Top', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-up-alt'
				),
				'right top'  => array(
					'label' => __( 'Top Right', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
			array(
				'left center'   => array(
					'label' => __( 'Left', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center center' => array(
				...
				'right center'  => array(
					'label' => __( 'Right', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
			array(
				'left bottom'   => array(
					'label' => __( 'Bottom Left', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-left-alt'
				),
				'center bottom' => array(
					'label' => __( 'Bottom', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-down-alt'
				),
				'right bottom'  => array(
					'label' => __( 'Bottom Right', 'medilazar-core' ),
					'icon'  => 'dashicons dashicons-arrow-right-alt'
				),
			),
		);
