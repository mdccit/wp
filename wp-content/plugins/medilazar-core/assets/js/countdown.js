	...
	$(document).ready(function(){
		$('[data-countdown="countdown"]').each(function(index, el) {
            ...
            $this.OpalCountDown({
                ...
                DisplayFormat:"<div class=\"countdown-times\"><div class=\"day\">%%D%% <span>"+$days+"</span></div><div class=\"hours\">%%H%% <span>"+$hours+"</span></div><div class=\"minutes\">%%M%% <span>"+$minutes+"</span></div><div class=\"seconds\">%%S%% <span>"+$seconds+"</span> </div></div>",
