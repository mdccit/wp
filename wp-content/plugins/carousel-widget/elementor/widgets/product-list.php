...
class Product_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product List', 'radios-tools' );
	}
            ...
            <div class="feature-two_block-inner">
                <div class="feature-two_block-image">
                    <?php if(function_exists('YITH_WCWL')):?>
                        <div class="heart-box"><?php echo do_shortcode( '[yith_wcwl_add_to_wishlist]' );?></div>
                    <?php endif;?>                    
                ...
                <h5 class="feature-two_block-heading"><a href="<?php the_permalink();?>"><?php echo wp_trim_words(get_the_title(), $settings['title_length'], '..')  ;?></a></h5>
                <div class="feature-two_block-price"><?php echo wp_kses_post($product->get_price_html()); ?></div>
            </div>
        </div>
        <?php 							
            } wp_reset_query();
...
Plugin::instance()->widgets_manager->register_widget_type( new Product_List() );