...
class Radios_Brand_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Radios Brand', 'radios-tools' );
	}
                ...
                <div class="brand__active">
                    ...
                    <div class="brand__item">
                        <a href="<?php echo esc_url($item['link']['url']);?>">
                            <img src="<?php echo esc_url($item['brand_logo']['url']);?>" alt="">
                        </a>
                    </div>
                    <?php endforeach;?>
                </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Radios_Brand_Carousel() );