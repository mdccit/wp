...
class Product_Tab extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Tab', 'radios-tools' );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Product_Tab() );