...
class Shop_Banner_Nine extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Shop Banner Nine', 'radios-tools' );
	}
    ...
    ?>
    <div class="kettle-add" style="background-image: url(<?php echo esc_url($settings['banner_img']['url']);?>)">
...
Plugin::instance()->widgets_manager->register_widget_type( new Shop_Banner_Nine() );